        ...
        <input placeholder="Search" className={style.input} />
          ...
          <table className={style.table} >
            <thead className={style.head} >
              <tr  >
                <th  >Date</th>
                <th>First name and Surname <img src={indicator} /></th>
                <th>Attribution</th>
                <th>Plan <img src={indicator} /></th>
                <th>Price <img src={indicator} /></th>
                <th>Bonuses <img src={indicator} /></th>
                <th>Payment <img src={indicator} /></th>
              </tr>
            </thead>
            <tbody>
